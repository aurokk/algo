...
public class Tests
{
    ...
    [TestCase("2147483648", -2147483648, new string[0])]
    [TestCase("00", 0, new[] { "0*0", "0+0", "0-0" })]
    public void Test_002(string input, int target, string[] expected)
    {
        var actual = new Solution().AddOperators_002(input, target);
        CollectionAssert.AreEquivalent(expected, actual);
    }
    ...
    [TestCase("2147483648", -2147483648, new string[0])]
    [TestCase("00", 0, new[] { "0*0", "0+0", "0-0" })]
    public void Test_003(string input, int target, string[] expected)
    {
        var actual = new Solution().AddOperators_003(input, target);
        CollectionAssert.AreEquivalent(expected, actual);
    }
}